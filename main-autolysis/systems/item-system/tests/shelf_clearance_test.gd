...
func _finish() -> void:
	...
	var directory: String = preload("res://main-autolysis/systems/item-system/tests/test_evidence.gd").directory(REPORT_PATH.get_base_dir())
	var absolute_path: String = ProjectSettings.globalize_path(directory.path_join(REPORT_PATH.get_file()))
